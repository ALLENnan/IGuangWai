 ...
 * 我发过的帖子   监听
 */
public class AsyncUserArticleListener implements OnQuantaAsyncListener {

	private Activity activity;

	// ArrayList<Article> articleList;

	public AsyncUserArticleListener(Activity activity) {
	...
	public void onComplete(int taskId, BaseMessage baseMessage) {
		...
		try {
			...
			UserArticleFragment.articleList = (ArrayList<Article>) baseMessage
					.getDataList("Article");
